...
# contact caching. Or modifying parameters? also note that for large iterations stack is stable and separation goes to 0 (^-12 or so).
#
#
#
...
#        obj2collidingVertex2
        ...
        self.J.append(J)
        self.zeta.append(-RESTITUTION*vrel)
