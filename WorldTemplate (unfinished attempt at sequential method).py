...
#        print obj1.idNum, obj2.idNum, minOverlap
        ...
        #Relative velocity of contact point in the normal direction, negative when approaching
        vrel = J[0]*obj1.speed[0] + J[1]*obj1.speed[1] + J[2]*obj1.speed[2] + J[3]*obj2.speed[0] + J[4]*obj2.speed[1] + J[5]*obj2.speed[2]
        
        kn = obj1.massInv + obj2.massInv + obj1.inertiaInv*(J[2]**2) + obj2.inertiaInv*(J[5]**2)
        
        self.Jmap.append((obj1.idNum, obj2.idNum))
        self.J.append(J)
        self.dPn.append((minOverlap*ERP/self.dt-(1+RESTITUTION)*vrel)/kn)
...
#        else:
        ...
        #ERRONEOUS! COLLISION DETECTION NEEDS ONLY DETECT 1 POINT, THEN DO THE CORRECT VERSION USING CLIPPING (SEE CATTO'S PRESENTATION)
